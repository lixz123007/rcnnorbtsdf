...
def masktry():
    ...
    for j in range(10000):
        t1=time.time()
        print("start i:",j," time:",t1)
        imgad = '/home/finch/data/rgb/'+str(j+1)+'.jpg'
        
        while(not(os.path.isfile(imgad))):
            time.sleep(0.01)
        ...
        img4=img.copy()
        img4[...]=255
        img5=np.zeros((img.shape), np.uint8)
        img5[...]=255
        t3=time.time()
        # t1=time.time()
        #print(result)
        ...
        # t4=time.time()
        cv2.imwrite('/home/finch/data/depth/'+str(j+1)+'.jpg',img5)
        cv2.imwrite('/home/finch/data/argb/'+str(j+1)+'.jpg',img4)
        t5=time.time()
        # print(time.time())
        # print(t5-t4)
        # print(t4-t3)
